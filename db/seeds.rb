...
channel_2 = Channel.create(name: "customer-support", workspace_id: demo_workspace.id, description: "For when you need help")
channel_3 = Channel.create(name: "information", workspace_id: demo_workspace.id, description: "For any questions you might have for me")
