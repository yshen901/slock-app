...
class BrowseChannelModal extends React.Component {
  ...
  render() {
    return (
      <div className="full-modal user-modal hidden" onClick={e => e.stopPropagation()}>
        <div className="full-modal-button" onClick={ () => { hideElements("full-modal user-modal"); this.setState({ search: "" }); } }>&#10005;</div>
